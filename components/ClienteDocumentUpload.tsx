...
export default function ClienteDocumentUpload({ clienteId, onUploadComplete }: ClienteDocumentUploadProps) {
          ...
          <div className="col-md-6 mb-3">
            <div className="border rounded p-3">
              ...
              <div 
                ...
                onClick={() => !uploading && triggerFileInput('residencia-input-cliente')}
                  ...
                  <div className="position-relative">
                    ...
                    <div className="d-flex gap-2 justify-content-center">
                      <button 
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          const input = document.getElementById('residencia-input-cliente') as HTMLInputElement;
          ...
          <div className="col-md-6 mb-3">
            <div className="border rounded p-3">
              ...
              <div 
                ...
                onClick={() => !uploading && tipoIdentidadeSelecionado && triggerFileInput('identidade-input-cliente')}
                style={{ 
                  ...
                  <div className="position-relative">
                    ...
                    <div className="d-flex gap-2 justify-content-center">
                      <button 
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          const input = document.getElementById('identidade-input-cliente') as HTMLInputElement;
                          const file = input.files?.[0];
                            ...
                            <button 
                              ...
                              onClick={() => {
                                if (documento.tipo === 'comprovante_residencia') {
                                  triggerFileInput('residencia-input-cliente');
                                } else {
                                  setTipoIdentidadeSelecionado(documento.tipo);
                                  setTimeout(() => triggerFileInput('identidade-input-cliente'), 100);
                                }
                              }}
                            >
